...
#' @description  Use PCA and select the first two PCs to reduce the dimension, then use multivariate normal distribution as the generative model and train 4 different models.
...
#'n0_test <- n1_test <- 300
#'
#'result = pilot_tfe_mvnorm_pca2(x_pilot,y_pilot,n0_train,n1_train,n0_test,n1_test)
#'
#'
#'
